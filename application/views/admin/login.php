              ...
              <div class="card wow fadeIn" data-wow-delay="0.3s">
                <div class="card-body">
                  ...
                  <div class="form-header peach-gradient">
                    <h3 class="font-weight-500 my-2 py-1"><i class="fas fa-user"></i> Log in Admin</h3>
                  </div>
                  ...
                  <form id="form-login" method="post">
                    ...
                    <div class="text-center">
                      <button id="btn-login" type="submit" class="btn peach-gradient btn-lg">Sign In</button>
                      <hr class="mt-4">
  ...
  <script type="text/javascript">
    $(document).ready(function() {
      ...
      $('#form-login').submit(function() {
        ...
        $.ajax({
          url: '<?= base_url('admin/login/masuk') ?>',
          type: 'POST',
          dataType:'json',
